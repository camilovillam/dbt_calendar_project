...
select
    ...
    -- Organizer (expanded)
    json_extract_string(je.value, '$.organizer.emailAddress.name')    as organizer_name,
    json_extract_string(je.value, '$.organizer.emailAddress.address') as organizer_email,
    ...
    json_extract_string(je.value, '$.responseStatus.time')     as event_response_time
